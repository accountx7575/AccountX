...
// Aapka provide kiya hua original transparent HD Stamp aur Signature[cite: 8]
const ABC_STAMP_SIGN = 'data:image/png;base64,';
...
<style>
  ...
  * {
  ...
  /* 3. SS 3 Fix: Large and crisp meta heading fonts */
  .company-cell-right {
    width: 50%;
    display: flex;
    align-items: center;
  ...
  /* 8. Total Styling: Font bold and clear */
  .total-row td {
    height: 8.5mm;
    padding: 4px 6px;
    background: #e5e5e5;
  ...
  /* 5 & 6. SS 5 & 6 Fix: GST Box as Separate Container Box */
  .gst-box-wrap {
    padding: 4px 0;
    border-bottom: 1.5px solid #000;
  }
  ...
  <div class="sheet">
    ...
    <table class="items">
      ...
      <tbody>
        ...
        <!-- 5. Total Row: Box closed with heavy bottom border -->
        <tr class="total-row">
          <td></td>
    ...
    <!-- 6. GST Tax Summary: Distinct Standalone Box -->
    ...
    <!-- Bottom: Bank Details, Terms, and Real Signature -->
    <div class="bottom">
...
(E. & O.E.)`
      ...
      <div class="bottom-cell-3">
        <div class="signature">
          <!-- 7. Stamp & Signature: Injected transparent HD image -->
