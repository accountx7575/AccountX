...
// Clean SVG Sign & Stamp representation to eliminate base64 print artifacting
const ABC_SIGN_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="220" height="90" viewBox="0 0 220 90">
  <text x="110" y="20" font-family="Arial, Helvetica, sans-serif" font-size="14" font-weight="bold" fill="%230b4da2" text-anchor="middle">For Avadh Boring Company</text>
  <path d="M 50 68 C 65 40, 85 28, 98 42 C 108 52, 92 78, 80 65 C 72 55, 95 38, 120 48 C 138 55, 115 72, 135 62 C 150 55, 175 56, 185 55 M 105 60 L 195 56" fill="none" stroke="%230b4da2" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
  <text x="195" y="72" font-family="Arial, Helvetica, sans-serif" font-size="15" font-weight="bold" fill="%230b4da2">Prop.</text>
</svg>`;
...
<style>
  ...
  * {
  ...
  /* 1. SS 1: Top Title with Underline */
  .top-title {
    height: 8.5mm;
    display: flex;
    align-items: center;
  ...
  /* Uniform 1px solid black border across the whole sheet */
  .sheet {
  ...
  /* 2. SS 2: Meta Grid - Same font size (11px), normal values, equal heights */
  .company-cell-right {
    width: 50%;
    display: flex;
    align-items: stretch;
  ...
  /* 3. SS 3: Address / Place of Supply / Mobile labels bold */
  .field-label {
    font-weight: 800;
    color: #000;
  }

  /* 4. SS 4: Items Table with aligned 50% center line & closed right border */
  .items-table-wrap {
    width: 100%;
    border-bottom: 1px solid #000;
  }
  ...
  /* 5. SS 5: Total Row Closed & Consistent */
  .total-row td {
    height: 8.5mm;
    padding: 4px 8px;
    background: #e5e5e5;
  ...
  /* 5. SS 5: GST Box with top margin gap */
  .gst-box-wrap {
    margin-top: 6px;
    border-top: 1px solid #000;
    border-bottom: 1px solid #000;
...
<body>
<div class="page">
  <!-- 1. Centered and Underlined QUOTATION Title -->
  ...
  <div class="sheet">
    ...
    <div class="company-row">
      ...
      <!-- 2. Meta Grid: Exact font sizing and normal data values -->
    ...
    <!-- 4. Items Table: Exactly 50% split on 2nd column (8% + 42% = 50%) -->
    ...
    <!-- Bottom: Bank Details, Terms & Conditions, and Vector Stamp -->
    <div class="bottom">
      ...
      <div class="bottom-cell-3">
        <div class="signature">
          <div class="stamp-wrap">
            <img src="${ABC_SIGN_SVG}" alt="Avadh Boring Company Sign"/>
          </div>
